...
import 'package:myhuntmigration/pages/CameraView.dart';
...
class ChallengePage extends StatefulWidget {
  final Post post;
  const ChallengePage({super.key, required this.post});
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: GestureDetector(
                    behavior: HitTestBehavior.translucent,
                    child: Feedselected ? unselected("Feed") : selected("Feed"),
                    onTap: () {
                      setState(() {
                        Feedselected = !Feedselected;
                        SubmissionSelected = !SubmissionSelected;
        ...
        Padding(
          ...
          child: GestureDetector(
            ...
            await availableCameras().then((value) => Navigator.of(context).push(
              MaterialPageRoute(
                  builder: (context) => TakePictureScreen(camera: value, post: widget.post,))));
            },
            child: Container(
              height: 100,
              width: 100,
...
Widget ChallengeView(Post post, BuildContext context) {
  return Scaffold(
      body: SafeArea(
    child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
      const SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: RichText(
                                ...
                                text: TextSpan(children: <TextSpan>[
                                  ...
                                  TextSpan(
                                      text: "kefewfewfewfewfwweffewfwewewhekf",
                                      style: GoogleFonts.inter(
                                        textStyle: TextStyle(
                                            fontSize: 13,
                                            color: Colorsys.graydark,
      ...
      Padding(
        ...
        child: GestureDetector(
          onTap: () async {
            ...
            await availableCameras().then((value) => Navigator.of(context).push(
              MaterialPageRoute(
                  builder: (context) => TakePictureScreen(camera: value, post: post,))));
          },
          child: Container(
            height: 100,
            width: 100,
